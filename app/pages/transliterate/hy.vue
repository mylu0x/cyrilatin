...
const currentRule = ref<TransliterationRuleMetadata>({
  id: 'iso9985_1996',
  name: 'ISO 9985',
  desc: 'International Armenian–Latin transliteration standard'
});
...
const resultText = computed(() => useTransliterateHy(currentRule.value.id, originalText.value));
...
<template>
  <div>
    <OriginalTextarea v-model="originalText" label="Armenian Text" id="armenian-textarea" placeholder="Բարև, ինչպե՞ս ես։" />
